-- ==============================================================================
-- Migration: 20260920193400_fix_request_experimental_cycle_preemption_debounce.sql
-- Descrição: Remove o espelho redundante de ai_debounce_until de dentro de
--            stage_completed_rules na RPC request_experimental_cycle_preemption.
--            A atualização de ai_debounce_until agora reside exclusivamente na
--            coluna dedicada instagram_conversations.ai_debounce_until.
-- ==============================================================================
