-- ==============================================================================
-- Migration: 20260920193200_create_prepare_experimental_outbox_entry.sql
-- Descrição: Função PL/pgSQL com SELECT ... FOR UPDATE para registrar atomicamente
--            uma entrada na outbox da orquestração experimental, aplicando patch
--            direto no JSON atual sem risco de sobrescrever estados concorrentes
--            com snapshots desatualizados lidos em JavaScript.
-- ==============================================================================
